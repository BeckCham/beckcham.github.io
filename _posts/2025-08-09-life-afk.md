...
I planned, led, and executed two workshops in partnership schemes connected to King Edward VI School. This scheme aims to provide primary school children with new experiences, broadening their horizons and enabling them to explore their interests. Both times I volunteered to help with this program, I was chosen to lead the planning and organisation of the activities. This all took place over the course of two days. On the first day, three other volunteers and I designed activities that would make up a 45-minute class. On the second day, we ran the workshop three times for a class of 30 children. 
...
I was selected to lead a less experienced team, which required me to design the workshop not only with the children in mind but also with consideration for what my peers felt confident delivering. Our aim was to introduce fundamental computer science concepts, so we selected activities that were both accessible and engaging. These included demonstrating logic gates using Raspberry Pi Picos with buttons and LEDs, explaining how computers “think” through interactive examples, teaching core programming constructs using LightBot, and presenting object-oriented programming in a simple, intuitive way using Pokémon as examples.

The workshop was highly successful. Student feedback indicated that they enjoyed the sessions, and a clear improvement in their understanding of algorithmic problem-solving and core concepts was evident by the end of the day. We also faced the additional challenge of working with an SEN group; however, by adapting our activities, increasing engagement, and actively listening to individual needs, we were able to accommodate this effectively and ensure a positive experience for everyone.
